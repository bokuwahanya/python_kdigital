...
class ElectricCar(Car):
    """전기차"""
    def __init__(self, make,model,year, large_battery=Battery()): #파라미터의 생성자는 위에 있는 배터리싸이즈에서 정의 그 객체를 밑에 self로 저장, 디폴트 파라미터 사용을 많이한다.
...
print (f"{large_battery_car.battery.get_range()}")
